 ...
 * @author 348337643
 */
public class Case8 extends javax.swing.JFrame {

    /**
     * Creates new form Case8
     */
    public Case8() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jRadioButton1.isSelected()) {
            Main_Frame.cases[7].verdict.setStudentVerdict("Ethical");
        } else if (jRadioButton2.isSelected()) {
            Main_Frame.cases[7].verdict.setStudentVerdict("Unethical");
        }

        // Store the user's explanation/reason from the text area
        Main_Frame.cases[7].verdict.setReason(jTextArea2.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Case8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
