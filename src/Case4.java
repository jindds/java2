...
public class Case4 extends javax.swing.JFrame {
    ...
    public Case4() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowActivated(WindowEvent e) {
                //add code here
                jLabel1.setText("Scenario #4: " + Main_Frame.cases[3].getCaseTitle());
                jLabel2.setText("Category: " + Main_Frame.cases[3].getCategory());
                jTextArea1.setText(Main_Frame.cases[3].getCaseDescription());
            }
        });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Main_Frame.cases[3].verdict.setCaseTitle(Main_Frame.cases[3].getCaseTitle());
        
        // Check which radio button the user selected
        if (jRadioButton1.isSelected()) {
            Main_Frame.cases[3].verdict.setStudentVerdict("Ethical");
        } else if (jRadioButton2.isSelected()) {
            Main_Frame.cases[3].verdict.setStudentVerdict("Unethical");
        }

        // Store the user's explanation/reason from the text area
        Main_Frame.cases[3].verdict.setReason(jTextArea2.getText());
