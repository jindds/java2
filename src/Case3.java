    ...
    public Case3() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowActivated(WindowEvent e) {
                //add code here
                jLabel1.setText("Scenario #3: " + Main_Frame.cases[2].getCaseTitle());
                jLabel2.setText("Category: " + Main_Frame.cases[2].getCategory());
                jTextArea1.setText(Main_Frame.cases[2].getCaseDescription());
            }
        });
